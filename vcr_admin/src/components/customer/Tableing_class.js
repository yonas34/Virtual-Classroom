...
export default function Tableing_class(props){
  const setRow=props.setRow;
  const rows=props.row;
  const headCells=props.column
...
await axios.post("https://10.42.0.1:8000/delete",selected).then((response)=>{
console.log(response.data);
